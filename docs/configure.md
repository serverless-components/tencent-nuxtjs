...
component: nuxtjs # (required) name of the component. In that case, it's express.
name: nuxtjsDemo # (required) name of your express component instance.
